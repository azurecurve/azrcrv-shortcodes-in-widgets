 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_siw')){
	function azrcrv_create_plugin_menu_siw(){
		azrcrv_create_plugin_menu_table_siw();
		azrcrv_populate_plugin_menu_table_siw();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_siw')){
	function azrcrv_populate_plugin_menu_table_siw(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_siw')){
	function azrcrv_create_plugin_menu_table_siw(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
